...
export default function PublisherHelpPage() {
  ...
  return (
    <>
      <ClientMetadata
        title="Help & Support - Publisher Dashboard"
        description="Get help and support for using the publisher dashboard. Find answers to content management questions and publishing guidelines."
        keywords={["publisher help", "support", "content management help"]}
        noIndex={true}
      />
      <div className="container mx-auto py-8 px-4">
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              manage requests. Learn how to make the most of your publisher
              role.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 p-6 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-800">
          ...
          <ul className="text-sm text-green-800 dark:text-green-200 space-y-2">
            ...
            <li>
              • <strong>Event Planning</strong> - Help organize family
        ...
        <div className="mt-8 text-center">
          <p className="text-muted-foreground">
            Need more help? Contact your admin or check the admin help center
